package com.uzykj.sms.module.processor;
...
public class AsyncProcessor {
    private static Logger log = Logger.getLogger(AsyncProcessor.class.getName());
    /**
     * 默认最大并发数<br>
     */
    ...
    static {
        ...
        try {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (!executor.awaitTermination(1, TimeUnit.SECONDS)) {
                            log.log(Level.WARNING, "AsyncProcessor shutdown immediately due to wait timeout.");
                            executor.shutdownNow();
                        }
                    } catch (InterruptedException e) {
                        log.log(Level.WARNING, "AsyncProcessor shutdown interrupted.");
                        executor.shutdownNow();
                    }
            ...
            log.log(Level.WARNING, "AsyncProcessor init error.", e);
